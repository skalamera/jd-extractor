 ...
 *
 * Used by the Jayobee Chrome Extension to sync job descriptions,
 ...
 * @returns {Promise<object>}
 */
async function syncJobToClyde(company, jdText, role = '', options = {}) {
  return request('POST', '/jobs', { company, role, jdText }, options);
}
