...
### Sigma — Technical Support Engineering Manager
**September 2025 – Present | New York, NY, USA**
...
- Deployed Claude Code agents to continuously monitor support queues, surface recurring issue patterns, and generate actionable trend reports — replacing manual analysis with always-on agentic intelligence that surfaces problems before they escalate.
- Built queue health agents that periodically audit each support engineer's backlog, analyze open Intercom conversations to identify stalled threads ready for resolution, and flag cases requiring immediate action — reducing case age and improving response consistency.
- Architected agentic workflows within Sigma using Sigma Agents and Snowflake Cortex Agents, building automated operational processes natively on the platform and progressively decommissioning third-party SaaS tools in favor of API and webhook-driven workflows.
- Provide hands-on support on complex technical issues and integrations, owning escalations for strategic enterprise accounts and driving a 23-second average live-chat first response time; act as escalation lead for SEV-0/SEV-1 incidents, coordinating with Engineering, Product, and Customer Success.
...
### Benchmark Education Company — Lead, Customer Technical Support & Support Operations
**March 2022 – September 2025 | New Rochelle, NY, USA**
...
### BuildingLink — Technical Support & Training
**October 2019 – March 2022 | New York, NY, USA**

- Hosted on-site and remote training sessions on platform to property management companies across the country.
- Translated user feedback and insights into actionable bug reports and feature requests for development teams.
- Managed team adoption of a new support ticketing system (Freshdesk).
- Assisted with redesign of the company's help site for enhanced user-friendliness, modernity, and robustness.

### 1010data — Customer Experience/Technical Support Lead
**April 2016 – August 2019 | New York, NY, USA**
...
- Managed interviewing, hiring, training, and expansion of the Customer Experience Team as one of the initial team members and a team leader.
...
### Lytx — Senior Technical Support Engineer, Tier 3
**July 2014 – April 2016 | San Diego, CA, USA**
...
- Utilized SQL to troubleshoot and query large databases.
- Interfaced with infrastructure, databases, QA, and development teams to address customer issues.

---

## Projects

### Jedana — Support Analytics Platform
**Founder & Developer**

- Built Jedana: a suite of AI-powered tools for support operations, focused on support analytics, agent/team performance, and customer health.
- Automated ticket quality assurance for agent coaching: AI analyzes interactions, provides detailed insights, and offers skill assessments with customizable AI-suggested ratings.
- Implemented real-time sentiment analysis and KPIs to track customer satisfaction, with AI-generated recommendations for CX improvement.
- Created custom weighted metrics to analyze, normalize, and rank agent performance across channels with AI-generated performance reviews.
...
Bachelor's, Economics | September 2005 – May 2010

---

## Awards

- Gold Stevie® Award Winner — 2025 American Business Awards®
